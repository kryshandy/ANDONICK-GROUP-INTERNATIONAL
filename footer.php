...
<a class="wa-float" href="https://wa.me/<?php echo esc_attr( andonick_wa( 'phone_rca1' ) ); ?>?text=<?php echo rawurlencode( andonick_t( 'wa_msg' ) ); ?>" target="_blank" rel="noopener" aria-label="WhatsApp">
